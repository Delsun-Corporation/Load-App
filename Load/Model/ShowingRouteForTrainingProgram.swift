...
class CardioActivityRouteTrainingProgram : Object{
    
    @objc dynamic var id = 0
    @objc dynamic var userId = ""
    @objc dynamic var weekWiseProgramId = 0
    ...
    let lapArray = List<LapDetailsForTrainingProgram>()
...
class LapDetailsForTrainingProgram : Object{
