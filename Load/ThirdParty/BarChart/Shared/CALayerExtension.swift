...
extension CALayer {
    ...
    func addTextLayer(frame: CGRect, color: CGColor, fontSize: CGFloat, text: String, animated: Bool, oldFrame: CGRect?) {
        ...
        textLayer.font = themeFont(size: 11, fontname: .ProximaNovaThin)
...
//        roundCorners(layer: gradientLayer, corners: [.topLeft, .topRight], radius: 4)
    ...
    func roundCorners(layer: CAGradientLayer, corners: UIRectCorner, radius: CGFloat) {
