...
public class SJSwiftSideMenuController: UIViewController, UINavigationControllerDelegate {
    ...
    private static func hideRightMenuOver() {
        showDimBackground(show: false)
        SJSwiftSideMenuController.validateForNavigationSetup() //Check for setup        SJSwiftSideMenuController.navigationContainer.view.bringSubviewToFront(SJSwiftSideMenuController.rightSideMenuView)
