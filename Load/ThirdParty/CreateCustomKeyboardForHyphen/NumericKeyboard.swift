...
class NumericKeyboard: UIView {
    // MARK: - outlets
    // numbers
    @IBOutlet weak var heightConstantOfView: NSLayoutConstraint!
    @IBOutlet weak var bottomConstantOfView: NSLayoutConstraint!
...
//    @IBOutlet weak var buttonKeyComma: UIButton!
    ...
    // all button outlets
    var allButtons: [UIButton] { return [buttonKey0, buttonKey1, buttonKey2, buttonKey3, buttonKey4, buttonKey5, buttonKey6, buttonKey7, buttonKey8, buttonKey9,buttonKeyHyphen] }
