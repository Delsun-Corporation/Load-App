//
//  CreateEventStepSecondVC-TableView_Extension.swift
//  Load
//
...
extension CreateEventStepOneVC:UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        self.mainView.imgLocation.isHidden = false
    }
