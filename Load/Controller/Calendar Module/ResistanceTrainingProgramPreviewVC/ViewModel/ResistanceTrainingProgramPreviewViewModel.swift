//
//  ResistanceTrainingProgramPreviewViewModel.swift
//  Load
//
...
class ResistanceTrainingProgramPreviewViewModel {

    fileprivate weak var theController: ResistanceTrainingProgramPreviewVC!
    ...
    init(theController:ResistanceTrainingProgramPreviewVC) {
        self.theController = theController
    }
    
    func setupUI() {
        let view = (self.theController.view as? ResistanceTrainingProgramPreviewView)
        ...
        ApiManager.shared.MakePostAPI(name: CREATE_TRAINING_PROGRAM , params: param as [String : Any], vc: self.theController, isAuth: false, completionHandler: { (response, error) in
            if response != nil {
                ...
                if success {
                    ...
                    self.theController.delegateDismissResistanceTrainingProgramPreview?.dismissResistanceTrainingProgramPreview()
