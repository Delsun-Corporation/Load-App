//
//  PresetResistanceTrainingProgramViewModel.swift
//  Load
//
...
class PresetResistanceTrainingProgramViewModel: CustomNavigationDelegate {

    fileprivate weak var theController: PresetResistanceTrainingProgramVC!
    
    init(theController:PresetResistanceTrainingProgramVC) {
