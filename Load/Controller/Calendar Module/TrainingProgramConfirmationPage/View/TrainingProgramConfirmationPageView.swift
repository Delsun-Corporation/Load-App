...
class TrainingProgramConfirmationPageView: UIView {
    ...
    @IBOutlet weak var lblColonChangeParameter: UILabel!
    @IBOutlet weak var widthConstraintForChangeParamter: NSLayoutConstraint!
...
//    @IBOutlet weak var txtAvgPace: UITextField!
    ...
    func setupUI(theController:TrainingProgramConfirmationPageVc){
        ...
        [lblTotalDistanceUnit,lblAvgSpeedUnit].forEach { (lbl) in
