//
//  ResistanceConfirmationPageVc+TableViewDelegate.swift
//  Load
//
...
extension ResistanceConfirmationPageVc: UITableViewDelegate, UITableViewDataSource, AddExerciseDelegate, ResistanceExerciseHeaderViewDelegate, ExerciseResistanceMainDelegate {
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        print("Count:\(self.mainModelView.exercisesMainArray.count)")
        print("isSelectedDusration Count : \(self.mainModelView.isSelectedDuration.count)")
