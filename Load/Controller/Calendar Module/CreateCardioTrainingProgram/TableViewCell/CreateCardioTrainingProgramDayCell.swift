...
protocol CreateCardioTrainingProgramDayDelegate: class {
    func CreateCardioTrainingProgramDayCellFinish(tag:Int)
}

class CreateCardioTrainingProgramDayCell: UITableViewCell {
    ...
    //MARK:- Variables
    weak var delegate:CreateCardioTrainingProgramDayDelegate?
    ...
    @IBAction func btnCellClicked(_ sender: Any) {
        self.delegate?.CreateCardioTrainingProgramDayCellFinish(tag: self.tag)
    }
}
