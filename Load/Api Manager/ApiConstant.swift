...
let CREATE_TRAINING_LOG = "\(newApiConfig ? "calendar/" : "")create-training-log"
let GET_TRAINING_LOG = "\(newApiConfig ? "calendar/" : "")get-training-log"
let SAVE_IS_LOG_FLAG = "\(newApiConfig ? "calendar/" : "")save-is-log-flag"
let TRAINING_LOG_DELETE = "\(newApiConfig ? "calendar/" : "")training-log-delete"
let TRAINING_LOG_UPDATE = "\(newApiConfig ? "calendar/" : "")training-log-update"
let COMPLETE_TRAINING_LOG = "\(newApiConfig ? "calendar/" : "")complete-training-log"
let TRAINING_LOG_LIST = "\(newApiConfig ? "calendar/" : "")training-log-list"
let LIBRARY_CREATE = "\(newApiConfig ? "library/" : "")library-create"
let LIBRARY_LIST = "\(newApiConfig ? "library/" : "")library-list"
let LIBRARY_DELETE = "\(newApiConfig ? "library/" : "")library-delete"
let LIBRARY_SET_FAVORITE = "\(newApiConfig ? "library/" : "")library-set-favorite"
let LIBRARY_SHOW = "\(newApiConfig ? "library/" : "")library-show"
let LIBRARY_UPDATE = "\(newApiConfig ? "library/" : "")library-update"
...
let TRAININIG_LOG_LIST = "\(newApiConfig ? "calendar/" : "")training-log-list"
let USERS_LIST = "users-list"
let USER = newApiConfig ? "setting/user" : "user"
let USER_UPDATE = newApiConfig ? "setting/user-update" : "user-update"
...
let CREATE_OR_UPDATE_PROFESSIONAL_PROFILE = "\(newApiConfig ? "setting/" : "")create-or-update-professional-profile"
let GET_PROFESSIONAL_PROFILE_DETAILS = "\(newApiConfig ? "setting/" : "")get-professional-profile-details"
let GET_SETTING_PROGRAM = "\(newApiConfig ? "setting/" : "")get-setting-program"
let SETTING_CREATE_UPDATE_PROGRAM = "\(newApiConfig ? "setting/" : "")setting-create-update-program"
...
let CREATE_TRAINING_PROGRAM = "\(newApiConfig ? "calendar/" : "")create-training-program"
let SAVE_WORKOUT_LIST = "save-workout-list"
let CHECK_PROGRAM_IS_AVAILABLE = "\(newApiConfig ? "calendar/" : "")check-program-is-available"
...
let LOG_RESISTANCE_VALIDATION_LIST = "\(newApiConfig ? "calendar/" : "")log-resistance-validation-list"
let CUSTOM_COMMON_LIBRARY_DETAILS = "custom-common-library-details"
let CREATE_UPDATE_COMMON_LIBRARY_DETAILS = "\(newApiConfig ? "library/" : "")create-update-common-library-detail"
let GET_EMERGENCY_CONTACT_DETAILS = "get-emergency-contact-details"
let ALL_TRAINING_UNITS_LIST = newApiConfig ? "setting/all-training-units-list" : "all-training-units-list"
...
let LOG_CARDIO_VALIDATION_LIST = "\(newApiConfig ? "calendar/" : "")log-cardio-validation-list"
let BOOKMARK_LIST = "bookmark-list"
let ADD_REMOVE_BOOKMARK = "create-delete-bookmark"
let GET_TRAINING_LOG_SUMMAARY_DETAILS = "\(newApiConfig ? "calendar/" : "")get-training-log-summary-details"
...
let TRAINING_PROGRAM_FLAGS = "\(newApiConfig ? "calendar/" : "")program-flags"
...
let GET_TRAINING_PROGRAM_SUMMAARY_DETAILS = "\(newApiConfig ? "calendar/" : "")get-training-program-summary-details"
